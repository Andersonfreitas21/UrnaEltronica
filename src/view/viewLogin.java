...
public class viewLogin extends javax.swing.JDialog {
    ...
    public boolean checkLogin(String l, String s) {
        return l.equals("user") && s.equals("123");
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Área de Acesso");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/icons8_User_Male_16px.png"))); // NOI18N

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/icons8_Password_16px_1.png"))); // NOI18N

        jSeparator1.setPreferredSize(new java.awt.Dimension(2, 2));

        jSeparator2.setPreferredSize(new java.awt.Dimension(2, 2));

        jlMsgLogin.setFont(new java.awt.Font("Century Gothic", 0, 10)); // NOI18N

        jlMsgSenha.setFont(new java.awt.Font("Century Gothic", 0, 10)); // NOI18N

        jLabel4.setBackground(new java.awt.Color(255, 255, 255));
        jLabel4.setFont(new java.awt.Font("Century Gothic", 1, 10)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/icons8_Copyright_14px_1.png"))); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jlMsgSenha, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jlMsgLogin, javax.swing.GroupLayout.PREFERRED_SIZE, 12, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jlMsgSenha, javax.swing.GroupLayout.PREFERRED_SIZE, 12, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jButton1)
                .addGap(29, 29, 29)
    ...
    private void txtLoginKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtLoginKeyReleased
        if (!txtLogin.getText().isEmpty()) {
            jlMsgLogin.setText("");
            jlMsgLogin.setForeground(Color.black);
    ...
    private void txtSenhaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSenhaKeyReleased
        ...
        if (!senha.isEmpty()) {
            jlMsgSenha.setText("");
            jlMsgSenha.setForeground(Color.black);
    ...
    private boolean checkLogin(JTextField txtLogin, JPasswordField txtSenha) {
